  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>Arjane</b> website is coming soon...</h1>
            </header>
            <!-- START TIMER -->
            ...
            <div class="col-lg-4 col-lg-offset-4 mt centered">
            	<h4>Let me know when you launch your site!</h4>
  ...
  <body class="nomobile">
    ...
    <section id="header">
        <div class="container">
            <header>
                <!-- HEADLINE -->
                <h1 data-animated="GoIn"><b>BILLKATE</b> website is coming soon...</h1>
            </header>
            <!-- START TIMER -->
            <div id="timer" data-animated="FadeIn">
                <p id="message"></p>
